...
import openlattice-rundeck.models
from openlattice-rundeck import rest
from openlattice-rundeck.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(openlattice-rundeck.models, klass)
